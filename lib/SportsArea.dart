...
import 'package:mourafik/videoinfo.dart';

import 'colors.dart' as color;


class SportsArea extends StatefulWidget {
  const SportsArea({Key? key}) : super(key: key);

  @override
  _SportsAreaState createState() => _SportsAreaState();
}

class _SportsAreaState extends State<SportsArea> {
  List<Info> info = [];
